...
import { getEventBySlug } from '../service/api';
      ...
      >
        <Row style={{ padding: '8vw', paddingTop: '2vw' }}>
          ...
          <Col sm={5}>
            ...
            >
              The COVID-19 crisis wreaked havoc on societies and economies and
              dealt a major setback to achieving the 2030 Agenda and the Paris
              Climate Agreement. Putting the world back on a path of
              sustainable, equitable, and inclusive growth will require more
              than a global recovery; it will require a Great Reset of social
          ...
          <Col sm={4} md={4} style={{ marginRight: '2vw', paddingLeft: '2vw' }}>
            <Image
              src="https://assets.weforum.org/tout/image/responsive_medium_yMLpolXHBKE84jMlg1o86IYFgQY3b8AGmPyfXpDLeUc.jpg"
              thumbnail
            />
            ...
            <Col sm={4}>
              ...
              >
                <Card.Body>
                  ...
                  <Card.Text>
                    World Economic Forum Partners are world-class companies with
                    a strong interest in developing systemic solutions to key
                    challenges Our Partners
                  </Card.Text>
                  <Button
                    variant="primary"
              ...
              >
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    experts, and partners, to scale their initiative and
              ...
              >
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    Development Goals and the champions working to achieve them
                    by 2030
                  </Card.Text>
                  <Button
                    variant="primary"
      ...
      >
        <Row>
          ...
          <Col sm={10} style={{ paddingTop: '1vw', fontSize: '1.3rem' }}>
            <p>ConsenSys: Revolutionizing clinical trial based research</p>
          </Col>
